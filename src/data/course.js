...
export const LEVELS = [
  ...
  },
  {
    ...
    sentences: [
      ...
      { en: 'my parents are happy', he: 'ההורים שלי שמחים' },
      { en: 'the boy hugs the baby', he: 'הילד מחבק את התינוק' },
      { en: 'grandfather tells a story', he: 'סבא מספר סיפור' },
      { en: 'the people are nice', he: 'האנשים נחמדים' },
    ],
  },
  {
    id: 'l3',
